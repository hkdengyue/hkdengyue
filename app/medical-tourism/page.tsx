...
export default function MedicalTourismPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f5f7fb]">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-r from-emerald-800 via-teal-700 to-cyan-700 text-white">

        <div className="max-w-7xl mx-auto px-6 py-20">

          <p className="uppercase tracking-[0.3em] text-sm text-emerald-200 mb-6">
            Cross-Border Healthcare
          </p>

          <h1 className="text-7xl font-black leading-tight max-w-5xl">
            International Patient Care
            and Medical Tourism in China
          </h1>
            ...
            <div className="lg:col-span-2 bg-white rounded-[2rem] overflow-hidden shadow-xl">
              ...
              <div className="relative h-[450px]">
                ...
                <Image
                  ...
                  alt={featuredPost?.title || "Medical Tourism"}
                  fill
              ...
              <div className="p-10">
                ...
                <p className="uppercase tracking-widest text-sm text-emerald-600 mb-4">
                  Featured Healthcare Story
                </p>

                <Link href={`/posts/${featuredPost.slug}`}>

                  <h2 className="text-5xl font-black leading-tight mb-6 hover:text-emerald-600 transition">
                    {featuredPost.title}
                  </h2>
                ...
                <Link href={`/posts/${featuredPost.slug}`}>
                  ...
                  <button className="bg-black hover:bg-emerald-700 text-white px-8 py-4 rounded-2xl text-lg transition">
                    Read Full Coverage
                  </button>
            ...
            {sidePosts.map((post) => (
              ...
              >
                ...
                <Link href={`/posts/${post.slug}`}>
                  ...
                  <h3 className="text-2xl font-bold leading-snug hover:text-emerald-600 transition mb-4">
                    {post.title}
                  </h3>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <h2 className="text-4xl font-bold">
            Latest Medical Tourism Updates
          </h2>
            ...
            >
              ...
              <div className="relative lg:w-72 h-52 rounded-2xl overflow-hidden flex-shrink-0">
                ...
                <Image
                  ...
                  alt={post.title || "Medical Tourism"}
                  fill
                  className="object-cover"
                />
              ...
              <div>
                ...
                <Link href={`/posts/${post.slug}`}>
                  ...
                  <h3 className="text-3xl font-bold mb-5 hover:text-emerald-600 transition">
                    {post.title}
                  </h3>
